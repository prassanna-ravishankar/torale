...
class UserQueryBase(BaseModel):
    raw_query: str = Field(..., min_length=1, description="The raw query submitted by the user")
    config_hints_json: Optional[Dict[str, Any]] = Field(None, description="Optional configuration hints for the query processing")
