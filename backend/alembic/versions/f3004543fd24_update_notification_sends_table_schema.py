...
down_revision: Union[str, Sequence[str], None] = '5ba730c9c123'
...
def upgrade() -> None:
    ...
    op.add_column('notification_sends', sa.Column('status', sa.Text(), nullable=False, server_default='success'))
...
def downgrade() -> None:
    ...
    op.drop_constraint('fk_notification_sends_execution_id', 'notification_sends', type_='foreignkey')
