...
async def test_compare_embeddings_identical(embedding_service):
    ...
    similarity = await embedding_service.compare_embeddings(embedding_json, embedding_json)
...
async def test_compare_embeddings_orthogonal(embedding_service):
    ...
    similarity = await embedding_service.compare_embeddings(embedding1_json, embedding2_json)
    assert isinstance(similarity, float)
...
async def test_generate_embedding_mocked(MockSentenceTransformer):
